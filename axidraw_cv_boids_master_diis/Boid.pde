class Boid 
{
  ...
  Boid(float x, float y, float maxspeed_inf_, float maxspeed_sup_, float maxforce_)  
  {
    ...
    r = 10.0;
    setMaxSpeed(maxspeed_inf_,maxspeed_sup_);
    setMaxForce(maxforce_);
  }

  void setMaxSpeed(float maxspeed_inf_, float maxspeed_sup_)
  {
    maxspeed = random(maxspeed_inf_, maxspeed_sup_);
  }

  void setMaxForce(float maxforce_)
  {
    maxforce = maxforce_;
  }
  ...
  PVector separate (ArrayList<Boid> boids) {
    float desiredseparation = 105.0f;
